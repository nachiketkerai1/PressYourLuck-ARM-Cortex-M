...
#define LOCATION_REMOTE_SPINS_X         225 
#define LOCATION_REMOTE_SPINS_Y         130 

#define LOCATION_LOCAL_PASSED_X         80 
#define LOCATION_LOCAL_PASSED_Y         155 
...
typedef enum game_info_cmd_t
{
    ...
    CMD_CLAIM_ACTIVE        =   0xB6,    /* Remote Users Claimed Active Player */
} game_info_cmd_t;
